...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if ([[preferences objectForKey:@"useBackgroundImage"] boolValue]) {
        self.backgroundView = [[UIImageView alloc] initWithFrame:[[self wrapperView] bounds]];
        self.backgroundView.contentMode = UIViewContentModeScaleAspectFill;
        self.backgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        self.backgroundView.image = [GcImagePickerUtils imageFromDefaults:@"love.litten.copypastapreferences" withKey:@"backgroundImage"];
        self.backgroundView.alpha = [[preferences objectForKey:@"backgroundAlpha"] doubleValue];
    ...
    self.headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 50, 44)];

    self.headerLabel = [[CPALabel alloc] initWithFrame:CGRectMake(0,0,100,44)];
    self.headerLabel.text = @"Copypasta";
    ...
    self.headerLabel.layoutMargins = UIEdgeInsetsMake(10, 10, 10, 10);
